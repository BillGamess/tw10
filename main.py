...
twitch_miner.mine(
    [
       ...
       Streamer("Stintik", settings=StreamerSettings(make_predictions=True , follow_raid=True  , claim_drops=True ,  watch_streak=True , community_goals=False  , bet=BetSettings(strategy=Strategy.HIGH_ODDS , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=5000  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_USERS,     where=Condition.GTE, value=1 ) ) )),
