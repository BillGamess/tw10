...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1352930579469045801/fAlua4XOSxVIqg3pUfAE8bXLp-SIRFMNNXPDrAjRP5bc4E3wSnN8H0oPx4Fxwgvv4gPZ",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
...
twitch_miner.mine(
    [
       ...
       Streamer("Stintik", settings=StreamerSettings(make_predictions=True , follow_raid=True  , claim_drops=True ,  watch_streak=True , community_goals=False  , bet=BetSettings(strategy=Strategy.HIGH_ODDS , percentage=5 , stealth_mode=False, percentage_gap=20 , max_points=5000  , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_POINTS,     where=Condition.GTE, value=250 ) ) )),
